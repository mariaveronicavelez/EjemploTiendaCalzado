...
public class Deportivo extends Calzado {
    ...
    //•	impuestoMaterial: retornará el valor de impuesto de material el cual es un 15% del valor base si el calzado es de Cuero y de un 6% del valor base si es de Lona
    public int impuestoMaterial(){
        int impuestoMaterial = -1;  //*= (this.getTipoMaterial().equals("Cuero")) ? Math.round(this.getProducto().getValorBase()*15/100) : (int) Math.round(this.getProducto().getValorBase()*0.06) ;
