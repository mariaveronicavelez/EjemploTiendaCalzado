...
public class Hombre extends Formal {
    ...
    //i.	Si hay Stock: disminuirá el stock en 1 y además, retornará el valor a pagar por el cliente, el cual será:
    // el valor venta menos los descuentos más impuestos (donde corresponda)
    ...
    public int descuento() { //o	Si el calzado es de hombre y de color es “Rojo” o “Verde el descuento será de un 25%
        //*return 0; //invento la logica para aplicar un descuento de hombre*/
        int descuento = 0;
