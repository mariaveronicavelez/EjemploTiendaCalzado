...
public class Aplicacion { //Define la estructura de la clase
    public static void main(String [] args){
        ...
        System.out.println("el valor venta del calzado hombre durante la " + hombre.getDiaVenta() + "es: $ "+ hombre.valorVenta());
        System.out.println("el valor venta del calzado mujer durante la " + mujer.getDiaVenta() + "es: $ "+ mujer.valorVenta());
